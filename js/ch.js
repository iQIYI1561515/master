//----------------------原生视频播放------------------
// $(".jj-lef-vedio").click(function(){
// 	// $(".jj-back").show();
// 	$(".jj-lef-vedio span").show();
// });
// var video1 =document.querySelector("video");
// var jj_back=document.querySelector(".jj-back");
// var play=document.querySelector("span");
// jj_back.onclick = function () {
// 				jj_back.style.display = "none";
// 				play.style.display = "none";
// 				if(video1.paused){
// 			        video1.play();					
// 			    }else if(video1.paused==false){
// 			        video1.pause();
